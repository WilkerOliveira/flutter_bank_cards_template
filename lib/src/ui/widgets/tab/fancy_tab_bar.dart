...
import 'package:bank_cards/src/ui/widgets/tab/fancy_tab_item.dart';
...
class FancyTabBar extends StatefulWidget {
  ...
  const FancyTabBar({Key key, @required this.onTabSelected}): super(key: key);
...
class _FancyTabBarState extends State<FancyTabBar>
  ...
  IconData nextIcon = Icons.credit_card;
  IconData activeIcon = Icons.credit_card;
          ...
          child: Row(
            ...
            children: <Widget>[
              TabItem(
                  ...
                  callbackFunction: () {
                    setState(() {
                      nextIcon = Icons.attach_money;
                      currentSelected = 0;
                    });
                    _initAnimationAndStart(_positionAnimation.value, -1);
                    this.widget.onTabSelected(currentSelected);
                  }),
              TabItem(
